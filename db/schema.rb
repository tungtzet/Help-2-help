...
ActiveRecord::Schema.define(version: 2020_08_11_052633) do
  ...
  create_table "user_diseases", force: :cascade do |t|
    ...
    t.index ["profile_id"], name: "index_user_diseases_on_profile_id"
  end
  ...
  add_foreign_key "user_diseases", "profiles"
end
